...
\usepackage{amsmath,amssymb,booktabs,hyperref,enumitem,microtype,algorithmic,longtable,array,graphicx}
\hypersetup{colorlinks=true,linkcolor=blue,urlcolor=blue,citecolor=blue}
\graphicspath{{paper/figures/}{empirical_runs/world_model_v1/paper/figures/}}
\title{Anchor-Conditioned Recurrent State-Space World Models for\\Probabilistic Multi-Asset Realized Volatility Paths}
\author{Tongren Xiao\thanks{Corresponding author: \href{mailto:easyglider458@gmail.com}{easyglider458@gmail.com}} \and Shuhang Chen\\[2pt]\small Independent Research Collaborators\\\small Code: \href{https://github.com/xtr1976536/volatility-world-model}{github.com/xtr1976536/volatility-world-model}\\\small Shuhang Chen: \href{mailto:chenshuhang491@gmail.com}{chenshuhang491@gmail.com}}
\date{September 2026}
...
Figures~\ref{fig:qlike}, \ref{fig:prob}, \ref{fig:path}, \ref{fig:train}, and~\ref{fig:extreme} summarize the forecast distribution using the same origin-level keys as the tables.
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.98\linewidth]{fig1_qlike_by_horizon.pdf}
\caption{Out-of-sample QLIKE by forecast horizon. Each point averages the 136 forecast origins and 30 assets for the indicated horizon.}
\label{fig:qlike}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.98\linewidth]{fig2_probabilistic_diagnostics.pdf}
\caption{AC-RSSM marginal diagnostics by horizon. Dashed lines mark nominal coverage levels.}
\label{fig:prob}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.98\linewidth]{fig3_path_diagnostics.pdf}
\caption{Temporal and cross-sectional path diagnostics.}
\label{fig:path}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.98\linewidth]{fig4_training_diagnostics.pdf}
\caption{End-of-block training diagnostics from the saved optimization histories.}
\label{fig:train}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=0.78\linewidth]{fig5_common_extreme_events.pdf}
\caption{Common high-volatility event rates. The threshold is the 90th percentile of realized cross-sectional mean RV.}
\label{fig:extreme}
\end{figure}
